...
const Home = () => {
	...
	return (
		<div className="flex w-full border border-slate-700/50 rounded-[2rem] shadow-[0_0_50px_rgba(6,182,212,0.1)] relative overflow-hidden bg-[#0F172A]/60 backdrop-blur-2xl transition-all duration-300">
			<div
				className={`${
					selectedChat && "hidden"
				} sm:block sm:w-[35%] w-full h-[82vh] bg-[#0B1120]/40 border-r border-slate-700/50 relative flex flex-col`}
			>
				<div className="absolute bottom-6 right-6 cursor-pointer text-white bg-gradient-to-r from-cyan-600 to-blue-600 p-4 rounded-2xl shadow-[0_0_20px_rgba(8,145,178,0.4)] hover:shadow-[0_0_30px_rgba(8,145,178,0.6)] transition-all duration-300 hover:scale-105 hover:-translate-y-1 z-10">
					<MdChat
						title="New Chat"
						fontSize={28}
			...
			<div
				className={`${
					!selectedChat && "hidden"
				} sm:block sm:w-[65%] w-full h-[82vh] bg-[#0B1120]/20 relative overflow-hidden`}
			>
				{selectedChat ? (
